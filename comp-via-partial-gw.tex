...
The following example shows lack of progress preservation when interface edges follow
interface choices 
$$
\begin{array}{c@{\qquad\qquad}c@{\hspace{1cm}}c@{\qquad}c}
    \begin{array}{cc}
...
[[*Conditions for interfaces edges*]](Claim: non necessary for deadlock-freedom)
