...
Mention the fact that we can take any automaton having some specific property w.r.t. $\noeps(M)$.
...
$$M^1_\hh = \noeps(M''_\hh)$$
for some $M''_\hh$ which is a $\roles$-dual of $\varepsilon(M'_\hh)$ where $M'_\hh= (Q, q_0, \textit{Act}, \bm{\delta})\in\IDS(M^2_\hh)$.\\
