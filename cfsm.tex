...
We define $\I(M)$ as the CFSM obtained out of $\bm{\varepsilon}(M)$ using the procedure
to get a FSA without $\varepsilon$-transitions out of a $\varepsilon$-FSA \cite[NfaEpsilonDefined.pdf in PAPERS] (without considering final states). 
Roughly:\\ 
